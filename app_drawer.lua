...
my_apps[1] = {
  ...
  { name = "Emacs", icon = icons["emacs"], exec = function() exe_app("emacs") end },
...
my_apps[2] = {
  ...
  { name = "Teams", icon = icons["teams"], exec = function()
    exe_app("teams")
  end },
...
my_apps[3] = {
  ...
  -- },
  title = "game-dev",
  { name = "Godot", icon = icons["selinux"], exec = function() exe_app("godot") end },
  keybindings = {
    { {}, 'g', function() exe_app("godot") end },
